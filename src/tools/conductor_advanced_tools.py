...
class ConductorAdvancedTools:
    ...
    def execute_agent_stateless(self, agent_id: str, input_text: str, 
                              timeout: int = 120, output_format: str = "text") -> dict:
    ...
    def execute_agent_contextual(self, agent_id: str, input_text: str, 
                               timeout: int = 120, clear_history: bool = False) -> dict:
    ...
    def start_interactive_session(self, agent_id: str, initial_input: str = None, 
    ...
    def migrate_storage(self, from_type: str, to_type: str, 
                       path: str = None, no_config_update: bool = False) -> dict:
